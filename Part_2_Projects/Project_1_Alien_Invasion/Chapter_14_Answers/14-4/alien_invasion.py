...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Start the game in inactive
        self.game_active = False

    def _make_difficulty_buttons(self):
        """Make buttons that allow users to choose difficulty level."""
        self.easy_button = Button(self, "Easy")
        self.medium_button = Button(self, "Medium")
        self.difficult_button = Button(self, "Difficult")

        # Place buttons so they don't overlap
        ...
        # Initialize the medium button to highlight
    ...
    def _check_play_button(self, mouse_pos):
        """Start a new game when users click play button."""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if not self.aliens:
            # Destroy current bullets and build fleet
            self.bullets.empty()
            self._create_fleet()
    ...
    def _update_aliens(self):
        """
        Check if the fleet is at a screen edge, then
        update the positions of all aliens in the fleet.
        """
        self._check_fleet_edges()
        self.aliens.update()

        # Look for aliens hitting ship
        if pygame.sprite.spritecollideany(self.ship, self.aliens):
            self._ship_hit()

        # Look for aliens touching the bottom of screen
    ...
    def _check_fleet_edges(self):
        """Respond to aliens hitting screen edge."""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        ...
        # Draw the play button if there is no action
