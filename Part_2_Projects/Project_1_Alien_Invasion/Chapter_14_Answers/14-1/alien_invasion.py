...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        """Start a new game when a user clicks play."""
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT:
            ...
            # Don't start new game with accidental click
            self._start_game()           
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove any bullets and aliens with collisions
        collisions = pygame.sprite.groupcollide(
                self.bullets, self.aliens, True, True)

        if not self.aliens:
            # Get rid of screen bullets make new fleet
            self.bullets.empty()
            self._create_fleet()
    ...
    def _update_aliens(self):
        """
        Update the positions of the fleet, check if 
        fleet is at an edge, then update positions
        """
    ...
    def _create_fleet(self):
        ...
        # Create an alien and add aliens
    ...
    def _change_fleet_direction(self):
        """Stop the entire fleet and change the fleet's direction."""
        for alien in self.aliens.sprites():
