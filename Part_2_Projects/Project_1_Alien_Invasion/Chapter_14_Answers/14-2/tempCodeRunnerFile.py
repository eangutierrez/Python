...
class TargetPractice:
    ...
    def _check_play_button(self, mouse_pos):
        """Start a new game when the user clicks the button."""
    ...
    def _start_game(self):
        ...
        # Get rid of all bullets
        self.bullets.empty()

        # Center ship and target
    ...
    def _update_bullets(self):
        ...
        Update stats for number of misses.
        """
    ...
    def _increment_misses(self):
        """Increment the number of misses, check if game shold end."""
