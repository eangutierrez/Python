#----------------------------------------------#
#-- PYTHON CRASH COURSE CHAPTER 19 EXERCISES --#
#----------------------------------------------#
#   
...
# These are the answers to the Chapter 19 exercises on Python Crash Course, 2nd Edition by Eric Matthes

# Problem 19.1: This problem asks to create a file called
...
############################################################################################################################
# Problem 19.2: This code builds on the code from Problem 19.1
...
############################################################################################################################
# Problem 19.3: This code asks the user for their name and 
...
############################################################################################################################
# Problem 19.4: This code builds on the code form Problem 19.3.
...
############################################################################################################################
# Problem 19.5: This code creates a while loop that asks people
...
############################################################################################################################
# Problem 19.6: This code creates a program that receives users'
...
############################################################################################################################
# Problem 19.7: This code takes the code from Problem 19.6 as base.
...
############################################################################################################################
# Problem 19.8: This code creates a program that reads
...
############################################################################################################################
# Problem 19.9: This code uses the code from Problem 19.8 as base.
...
############################################################################################################################
# Problem 19.10: This code creates program that counts how
...
############################################################################################################################
# Problem 19.11: This problem asks to create two programs,
...
############################################################################################################################
# Problem 19.12: This code combines the two programs from Problem
# 19.11, and adds extra functionality. If the user's number is
...
############################################################################################################################
# Problem 19.13: This code creates a list of Japanese mountains and performs the functions used in this chapter once
print("Problem 19.13")