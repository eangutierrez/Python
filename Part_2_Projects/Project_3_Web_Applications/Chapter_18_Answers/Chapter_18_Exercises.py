#----------------------------------------------#
#-- PYTHON CRASH COURSE CHAPTER 18 EXERCISES --#
#----------------------------------------------#
#   
...
# These are the answers to the Chapter 18 exercises on Python Crash Course, 2nd Edition by Eric Matthes

# Problem 18.1: This problem asks to create a file called
...
############################################################################################################################
# Problem 18.2: This code builds on the code from Problem 18.1
...
############################################################################################################################
# Problem 18.3: This code asks the user for their name and 
...
############################################################################################################################
# Problem 18.4: This code builds on the code form Problem 18.3.
...
############################################################################################################################
# Problem 18.5: This code creates a while loop that asks people
...
############################################################################################################################
# Problem 18.6: This code creates a program that receives users'
...
############################################################################################################################
# Problem 18.7: This code takes the code from Problem 18.6 as base.
...
############################################################################################################################
# Problem 18.8: This code creates a program that reads
...
############################################################################################################################
# Problem 18.9: This code uses the code from Problem 18.8 as base.
...
############################################################################################################################
# Problem 18.10: This code creates program that counts how
...
############################################################################################################################
# Problem 18.11: This problem asks to create two programs,
...
############################################################################################################################
# Problem 18.12: This code combines the two programs from Problem
# 18.11, and adds extra functionality. If the user's number is
...
############################################################################################################################
# Problem 18.13: This code creates a list of Japanese mountains and performs the functions used in this chapter once
print("Problem 18.13")