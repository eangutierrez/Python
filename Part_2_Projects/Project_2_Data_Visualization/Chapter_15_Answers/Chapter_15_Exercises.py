#----------------------------------------------#
#-- PYTHON CRASH COURSE CHAPTER 15 EXERCISES --#
#----------------------------------------------#
#   
...
# These are the answers to the Chapter 15 exercises on Python Crash Course, 2nd Edition by Eric Matthes

# Problem 15.1: This problem asks to create a file called
...
############################################################################################################################
# Problem 15.2: This code builds on the code from Problem 15.1
...
############################################################################################################################
# Problem 15.3: This code asks the user for their name and 
...
############################################################################################################################
# Problem 15.4: This code builds on the code form Problem 15.3.
...
############################################################################################################################
# Problem 15.5: This code creates a while loop that asks people
...
############################################################################################################################
# Problem 15.6: This code creates a program that receives users'
...
############################################################################################################################
# Problem 15.7: This code takes the code from Problem 15.6 as base.
...
############################################################################################################################
# Problem 15.8: This code creates a program that reads
...
############################################################################################################################
# Problem 15.9: This code uses the code from Problem 15.8 as base.
...
############################################################################################################################
# Problem 15.10: This code creates program that counts how
...
############################################################################################################################
# Problem 15.11: This problem asks to create two programs,
...
############################################################################################################################
# Problem 15.12: This code combines the two programs from Problem
# 15.11, and adds extra functionality. If the user's number is
...
############################################################################################################################
# Problem 15.13: This code creates a list of Japanese mountains and performs the functions used in this chapter once
print("Problem 15.13")