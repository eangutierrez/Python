#----------------------------------------------#
#-- PYTHON CRASH COURSE CHAPTER 16 EXERCISES --#
#----------------------------------------------#
#   
...
# These are the answers to the Chapter 16 exercises on Python Crash Course, 2nd Edition by Eric Matthes

# Problem 16.1: This problem asks to create a file called
...
############################################################################################################################
# Problem 16.2: This code builds on the code from Problem 16.1
...
############################################################################################################################
# Problem 16.3: This code asks the user for their name and 
...
############################################################################################################################
# Problem 16.4: This code builds on the code form Problem 16.3.
...
############################################################################################################################
# Problem 16.5: This code creates a while loop that asks people
...
############################################################################################################################
# Problem 16.6: This code creates a program that receives users'
...
############################################################################################################################
# Problem 16.7: This code takes the code from Problem 16.6 as base.
...
############################################################################################################################
# Problem 16.8: This code creates a program that reads
...
############################################################################################################################
# Problem 16.9: This code uses the code from Problem 16.8 as base.
...
############################################################################################################################
# Problem 16.10: This code creates program that counts how
...
############################################################################################################################
# Problem 16.11: This problem asks to create two programs,
...
############################################################################################################################
# Problem 16.12: This code combines the two programs from Problem
# 16.11, and adds extra functionality. If the user's number is
...
############################################################################################################################
# Problem 16.13: This code creates a list of Japanese mountains and performs the functions used in this chapter once
print("Problem 16.13")