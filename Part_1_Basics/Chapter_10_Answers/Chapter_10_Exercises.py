#----------------------------------------------#
#-- PYTHON CRASH COURSE CHAPTER 10 EXERCISES --#
#----------------------------------------------#
#   
...
# These are the answers to the Chapter 10 exercises on Python Crash Course, 2nd Edition by Eric Matthes

# Problem 10.1: This problem asks to create a file called
...
############################################################################################################################
# Problem 10.2: This code builds on the code from Problem 10.1
...
############################################################################################################################
# Problem 10.3: This code asks the user for their name and 
...
############################################################################################################################
# Problem 10.4: This code builds on the code form Problem 10.3.
...
############################################################################################################################
# Problem 10.5: This code creates a while loop that asks people
...
############################################################################################################################
# Problem 10.6: This code creates a program that receives users'
...
############################################################################################################################
# Problem 10.7: This code takes the code from Problem 10.6 as base.
...
############################################################################################################################
# Problem 10.8: This code creates a program that reads
...
############################################################################################################################
# Problem 10.9: This code uses the code from Problem 10.8 as base.
...
############################################################################################################################
# Problem 10.10: This code creates program that counts how
...
############################################################################################################################
# Problem 10.11: This problem asks to create two programs,
...
############################################################################################################################
# Problem 10.12: This code combines the two programs from Problem
# 10.11, and adds extra functionality. If the user's number is
...
############################################################################################################################
# Problem 10.13: This code creates a list of Japanese mountains and performs the functions used in this chapter once
print("Problem 10.13")
import json
...
def greet_user():
    ...
    if username:
        correct = input(f"Is it you, {username}? (yes/no) ")
        if correct == 'y':
